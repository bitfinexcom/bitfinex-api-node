...
class ClientManager {
   ...
   * @param {WSv2~Configuration} opts.ws - ws transport options
   ...
   *
   * @param {number} [version=2] - 1 or 2
   * @param {WSv2~Configuration} [extraOpts={}] - passed to transport
   *   constructor
   * @returns {WSv2|bfx-api-node-ws1.WSv1} transport
   */
