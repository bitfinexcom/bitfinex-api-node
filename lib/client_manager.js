 ...
 *
 * @see module:bitfinex-api-node.WSv2
 * @see module:bfx-api-node-ws1.WSv1
 * @see module:bfx-api-node-rest.RESTv2
 * @see module:bfx-api-node-rest.RESTv1
 *
 * @class
...
class ClientManager {
   ...
   * @param {module:bitfinex-api-node.WSv2~Configuration} opts.ws - ws
   *   transport options
   ...
   *
   * @param {number} [version=2] - 1 or 2
   * @param {module:bitfinex-api-node.WSv2~Configuration} [extraOpts={}] -
   *   passed to transport constructor
   * @returns {(
