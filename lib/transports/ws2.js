...
class WSv2 extends EventEmitter {
  ...
  /**
   * Creates internal WS client; if it already exists, an error is thrown
   *
  ...
  /**
   * Closes the internal WS client; if it is not open, an error is thrown
   *
   ...
   * authenticated, an error is thrown
   *
