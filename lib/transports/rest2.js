...
class RESTv2 {
   ...
   */
  currencies (cb = () => {}) {
    return this._makePublicRequest(`/conf/pub:list:currency,pub:map:currency:sym,pub:map:currency:label`, cb, (data) => {
