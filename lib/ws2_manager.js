...
class WS2Manager extends EventEmitter {
  /**
   * @param {WSv2~Configuration} socketArgs - passed to {@link WSv2}
   *   constructor
  ...
  /**
   * @param {WS2Manager~SocketState} s - socket state
   ...
   * @returns {WS2Manager~SocketState} state
   */
  getSocket (i) {
   ...
   * DATA_CHANNEL_LIMIT
   *
   * @returns {WS2Manager~SocketState} state - undefined if none found
   */
  getFreeDataSocket () {
   ...
   * @returns {WS2Manager~SocketState} wsState -
