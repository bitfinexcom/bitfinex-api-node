...
const getMessagePayload = (msg = []) => {
  return _findLast(msg, i => _isArray(i))
}
...
class WSv2 extends EventEmitter {
   ...
   * await ws.open()
   *
   * @param {WSv2~Configuration} [config] - client
   *   configuration
   */
  constructor (config = {
    apiKey: '',
   ...
   * @see {@link WSv2#subscribeTrades}
   * @see {@link WSv2#subscribeTicker}
   * @see {@link WSv2#subscribeCandles}
   * @see {@link WSv2#subscribeOrderBook}
   */
  getDataChannelCount () {
    return Object
   ...
   * @see {@link WSv2#managedSubscribe}
   */
   ...
   *
   * @param {string} symbol - symbol for order book
   * @returns {bfx-api-node-models.OrderBook} ob - null if not found
   */
  getOB (symbol) {
   ...
   *   bfx-api-node-models.Candle~ArrayData[]
   ...
   *
   * @see {@link WSv2#cancelOrders}
   * @see {@link WSv2#cancelOrder}
   * @see {@link WSv2#updateOrder}
   *
   * @example
   * const o = new Order({
   ...
   *   and authenticated
   *
   * @param {bfx-api-node-models.Notification~BroadcastPayload} opts -
   *   broadcast payload
   */
  notifyUI (opts = {}) {
   ...
   * received.
   *
   * @param {number} code - from {@link WSv2.info}
   ...
   * @see {@link WSv2#subscribeCandles}
   * @see {@link WSv2#unsubscribeCandles}
   */
   ...
   * @see {@link WSv2#subscribeOrderBook}
   * @see {@link WSv2#unsubscribeOrderBook}
   */
   ...
   * @see {@link WSv2#subscribeTrades}
   * @see {@link WSv2#unsubscribeTrades}
   */
   ...
   * @see {@link WSv2#subscribeTicker}
   * @see {@link WSv2#unsubscribeTicker}
   */
